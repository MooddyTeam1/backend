...
INSERT INTO projects (
  ...
  -- ✅ SCHEDULED: 지금은 아직 오픈 전 (곧 오픈 예정)
  (1200, 1003,
   '오로라 자동조명',
   '하루 리듬에 맞춰 색온도를 조절하는 책상 조명입니다.',
   '## 오로라 자동조명 - 재택 근무자에게 건강한 빛 환경을 제공합니다.',
   2000000,
   NOW() + INTERVAL '7 days',         -- start_at: D+7
   NOW() + INTERVAL '37 days',        -- end_at: D+37
   'TECH',
   'SCHEDULED',
   'APPROVED',
   'NONE',
   ...
   NOW() - INTERVAL '3 days',
   NOW() - INTERVAL '1 days',
   NOW() + INTERVAL '7 days',         -- 공개 예정 시작일
   NOW() + INTERVAL '37 days',
   NULL),

  -- ✅ LIVE: 이미 시작했고, 아직 종료 전 (중간쯤 진행 중)
  (1201, 1003,
   '펄스핏 모듈 밴드',
   '센서를 교체하며 데이터를 맞춤 수집하는 피트니스 밴드입니다.',
   '## 펄스핏 모듈 밴드 - 스타일을 유지하면서도 유의미한 바이오 데이터를 기록합니다.',
   3000000,
   NOW() - INTERVAL '3 days',         -- start_at: 3일 전
