...
VALUES
  (1200, 1003, '오로라 자동조명',
   ...
   'TECH', 'SCHEDULED', 'APPROVED', 'PREPARING',
  ...
  (1203, 1004, '지오트레일 스마트 백팩',
   ...
   'FASHION', 'LIVE', 'APPROVED', 'PREPARING',
  ...
  (1205, 1003, '홈라이트', '고속충전 LED 스탠드', '## 홈라이트', 150000, DATE '2025-11-01', DATE '2025-12-15',
   'HOME_LIVING', 'LIVE', 'APPROVED', 'PREPARING',
...
VALUES
  ...
  (1215, 1003, '사일런트큐브 공기정화기',
   ...
   'HOME_LIVING', 'SCHEDULED', 'APPROVED', 'PREPARING',
...
VALUES
  (1216, 1006, '에어브릿지 메쉬 라우터', '거실/방까지 끊김 없는 메쉬 라우터', '## 에어브릿지' || chr(10) || '메쉬 네트워크 자동 최적화', 30000000, DATE '2025-11-01', DATE '2025-12-20',
   'TECH', 'LIVE', 'APPROVED', 'PREPARING', TIMESTAMP '2025-10-20 09:00:00', TIMESTAMP '2025-10-22 10:00:00', NULL, NULL,
  ...
  (1217, 1006, '나노파워 배터리팩', '초경량 20000mAh 배터리팩', '## 나노파워' || chr(10) || '여행용 고속충전 배터리', 28000000, DATE '2026-01-05', DATE '2026-02-15',
   'TECH', 'SCHEDULED', 'APPROVED', 'PREPARING', TIMESTAMP '2025-12-01 09:00:00', TIMESTAMP '2025-12-03 10:00:00', NULL, NULL,
  ...
  (1218, 1007, '모노브릭 데스크오거나이저', '책상 위를 정리해주는 모듈형 오거나이저', '## 모노브릭' || chr(10) || '알루미늄/우드 하이브리드', 20000000, DATE '2025-11-02', DATE '2025-12-22',
   'DESIGN', 'LIVE', 'APPROVED', 'PREPARING', TIMESTAMP '2025-10-21 09:00:00', TIMESTAMP '2025-10-23 10:00:00', NULL, NULL,
  ...
  (1219, 1007, '리플폴드 플랜터', '물결 모양 폴딩 플랜터', '## 리플폴드' || chr(10) || '접어서 보관하는 실내 플랜터', 22000000, DATE '2026-01-10', DATE '2026-02-28',
   'DESIGN', 'SCHEDULED', 'APPROVED', 'PREPARING', TIMESTAMP '2025-12-05 09:00:00', TIMESTAMP '2025-12-07 10:00:00', NULL, NULL,
  ...
  (1220, 1008, '스모크버터 스테이크 키트', '고온 버터 베이스 스테이크 키트', '## 스모크버터' || chr(10) || '건조 숙성 + 향미 버터', 35000000, DATE '2025-11-03', DATE '2025-12-23',
   'FOOD', 'LIVE', 'APPROVED', 'PREPARING', TIMESTAMP '2025-10-22 09:00:00', TIMESTAMP '2025-10-24 10:00:00', NULL, NULL,
  ...
  (1221, 1008, '코코넛바닐라 디저트 세트', '코코넛/바닐라 디저트 4종', '## 코코넛바닐라' || chr(10) || '냉동 디저트 큐레이션', 25000000, DATE '2026-01-15', DATE '2026-02-28',
   'FOOD', 'SCHEDULED', 'APPROVED', 'PREPARING', TIMESTAMP '2025-12-10 09:00:00', TIMESTAMP '2025-12-12 10:00:00', NULL, NULL,
  ...
  (1222, 1009, '시에라라인 소프트셸 재킷', '경량 방풍 소프트셸 재킷', '## 시에라라인' || chr(10) || '러닝/하이킹 겸용', 40000000, DATE '2025-11-04', DATE '2025-12-24',
   'FASHION', 'LIVE', 'APPROVED', 'PREPARING', TIMESTAMP '2025-10-23 09:00:00', TIMESTAMP '2025-10-25 10:00:00', NULL, NULL,
  ...
  (1223, 1009, '라이트패스 러닝팩', '야간 러닝용 슬링백', '## 라이트패스' || chr(10) || '리플렉티브 + 라이트 가이드', 30000000, DATE '2026-01-20', DATE '2026-03-01',
   'FASHION', 'SCHEDULED', 'APPROVED', 'PREPARING', TIMESTAMP '2025-12-15 09:00:00', TIMESTAMP '2025-12-17 10:00:00', NULL, NULL,
  ...
  (1224, 1010, '미드나잇 세럼 듀오', '야간 루틴 집중 세럼', '## 미드나잇 듀오' || chr(10) || '레티놀 + 세라마이드', 25000000, DATE '2025-11-05', DATE '2025-12-25',
   'BEAUTY', 'LIVE', 'APPROVED', 'PREPARING', TIMESTAMP '2025-10-24 09:00:00', TIMESTAMP '2025-10-26 10:00:00', NULL, NULL,
  ...
  (1225, 1010, '코지바디 아로마미스트', '데일리 아로마 미스트', '## 코지바디' || chr(10) || '피부/패브릭 겸용', 20000000, DATE '2026-01-25', DATE '2026-03-05',
   'BEAUTY', 'SCHEDULED', 'APPROVED', 'PREPARING', TIMESTAMP '2025-12-20 09:00:00', TIMESTAMP '2025-12-22 10:00:00', NULL, NULL,
  ...
  (1226, 1011, '엘름우드 무선 스탠드', '무선 충전 기능이 있는 조명 스탠드', '## 엘름우드' || chr(10) || '충전패드 일체형', 30000000, DATE '2025-11-06', DATE '2025-12-26',
   'HOME_LIVING', 'LIVE', 'APPROVED', 'PREPARING', TIMESTAMP '2025-10-25 09:00:00', TIMESTAMP '2025-10-27 10:00:00', NULL, NULL,
  ...
  (1227, 1011, '웨이브폼 디퓨저', '곡선 디자인 무드 디퓨저', '## 웨이브폼' || chr(10) || '조명+디퓨저 2in1', 22000000, DATE '2026-02-01', DATE '2026-03-20',
   'HOME_LIVING', 'SCHEDULED', 'APPROVED', 'PREPARING', TIMESTAMP '2025-12-25 09:00:00', TIMESTAMP '2025-12-27 10:00:00', NULL, NULL,
  ...
  (1228, 1012, '아크폴리 전술 보드게임', '세트컬렉션 전략 보드게임', '## 아크폴리' || chr(10) || '확장팩 포함 얼리버드', 50000000, DATE '2025-11-07', DATE '2025-12-27',
   'GAME', 'LIVE', 'APPROVED', 'PREPARING', TIMESTAMP '2025-10-26 09:00:00', TIMESTAMP '2025-10-28 10:00:00', NULL, NULL,
  ...
  (1229, 1012, '픽셀노바 카드 컬렉션', '픽셀 아트 카드 수집 시리즈', '## 픽셀노바' || chr(10) || '리미티드 프린트 런', 26000000, DATE '2026-02-10', DATE '2026-03-25',
   'GAME', 'SCHEDULED', 'APPROVED', 'PREPARING', TIMESTAMP '2026-01-05 09:00:00', TIMESTAMP '2026-01-07 10:00:00', NULL, NULL,
  ...
  (1230, 1013, '스펙트럼 실크스크린 프린트', '한정판 실크스크린 포스터', '## 스펙트럼' || chr(10) || '2종 세트 에디션', 22000000, DATE '2025-11-08', DATE '2025-12-28',
   'ART', 'LIVE', 'APPROVED', 'PREPARING', TIMESTAMP '2025-10-27 09:00:00', TIMESTAMP '2025-10-29 10:00:00', NULL, NULL,
  ...
  (1231, 1013, '드리프트 컬러링북', '여행 테마 컬러링북', '## 드리프트' || chr(10) || '아트 프린트 포함', 18000000, DATE '2026-02-15', DATE '2026-03-30',
   'ART', 'SCHEDULED', 'APPROVED', 'PREPARING', TIMESTAMP '2026-01-10 09:00:00', TIMESTAMP '2026-01-12 10:00:00', NULL, NULL,
  ...
  (1232, 1014, '더라이트 포토에세이북', '밤의 도시를 담은 포토에세이', '## 더라이트' || chr(10) || '120p 하드커버', 28000000, DATE '2025-11-09', DATE '2025-12-29',
   'PUBLISH', 'LIVE', 'APPROVED', 'PREPARING', TIMESTAMP '2025-10-28 09:00:00', TIMESTAMP '2025-10-30 10:00:00', NULL, NULL,
  ...
  (1233, 1014, '아틀라스 트래블 로그북', '여행 기록용 하드커버 로그북', '## 아틀라스' || chr(10) || '스티커/포켓 포함', 24000000, DATE '2026-02-20', DATE '2026-04-05',
   'PUBLISH', 'SCHEDULED', 'APPROVED', 'PREPARING', TIMESTAMP '2026-01-15 09:00:00', TIMESTAMP '2026-01-17 10:00:00', NULL, NULL,
