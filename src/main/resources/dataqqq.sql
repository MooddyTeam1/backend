...
INSERT INTO makers (id, owner_user_id, maker_type, name, business_name, business_number, representative, established_at, industry_type, location, product_intro, core_competencies, image_url, contact_email, contact_phone, tech_stack, created_at, updated_at) VALUES
  (1003, 1003, 'BUSINESS', '메이커원 스튜디오', '메이커원 스튜디오', '110-22-334455', '박알리스', DATE '2021-03-15',
   ...
   'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80', 'maker1@test.com', '010-1111-0001',
  ...
  (1004, 1004, 'BUSINESS', '트레일랩스', 'Trail Labs Co.', '220-33-778899', '최브라이언', DATE '2020-05-20',
   ...
   'https://images.unsplash.com/photo-1501555088652-021faa106b9b?auto=format&fit=crop&w=800&q=80', 'maker2@test.com', '010-1111-0002',
   '["Kotlin","LoRa","AWS IoT"]',
...
INSERT INTO makers (id, owner_user_id, maker_type, name, business_name, business_number, representative, established_at, industry_type, location, product_intro, core_competencies, image_url, contact_email, contact_phone, tech_stack, created_at, updated_at) VALUES
  (1006, 1025, 'BUSINESS', '네온라이트 랩스', '네온라이트', '310-11-000001', '오주하', DATE '2022-02-10',
   ...
   '메쉬 네트워크, 펌웨어, UX리서치',
   'https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?auto=format&fit=crop&w=800&q=80', 'neonlight.owner@test.com', '010-5000-1001',
  ...
  (1007, 1026, 'BUSINESS', '스톤앤라운드 디자인', '스톤앤라운드', '310-11-000002', '심이든', DATE '2021-06-10',
   ...
   '산업 디자인, 패키징, 소재 연구',
   'https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=800&q=80', 'stone.owner@test.com', '010-5000-1002',
   '["CAD","CNC","Packaging"]',
  ...
  (1008, 1027, 'BUSINESS', '소금골목 다이닝', '소금골목', '310-11-000003', '박연주', DATE '2020-12-01',
   ...
   '레시피 개발, 콜드체인, 푸드 포토',
   'https://images.unsplash.com/photo-1577219491135-ce391730fb2c?auto=format&fit=crop&w=800&q=80', 'salt.owner@test.com', '010-5000-1003',
   '["Recipe","Branding"]',
  ...
  (1009, 1028, 'BUSINESS', '노던트레일 웨어', '노던트레일', '310-11-000004', '하태린', DATE '2021-04-04',
   ...
   '패턴, 내구성 소재, 경량화',
   'https://images.unsplash.com/photo-1524805444758-089113d48a6d?auto=format&fit=crop&w=800&q=80', 'trail.owner@test.com', '010-5000-1004',
  ...
  (1010, 1029, 'BUSINESS', '미드나잇 블루밍', '미드나잇', '310-11-000005', '이예나', DATE '2022-03-03',
   ...
   '원료 소싱, 향 블렌딩, 피부 임상',
   'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?auto=format&fit=crop&w=800&q=80', 'midnight.owner@test.com', '010-5000-1005',
   '["Formulation","Brand"]',
  ...
  (1011, 1030, 'BUSINESS', '브릭앤우드 리빙', '브릭앤우드', '310-11-000006', '정윤재', DATE '2021-09-09',
   ...
   '목가구, 금속가공, IoT 조명',
   'https://images.unsplash.com/photo-1611244419377-b0a760c19719?auto=format&fit=crop&w=800&q=80', 'brick.owner@test.com', '010-5000-1006',
   '["Wood","Metal","IoT"]',
  ...
  (1012, 1031, 'BUSINESS', '레벨업 크리에이티브', '레벨업', '310-11-000007', '류도현', DATE '2020-08-08',
   ...
   '게임 기획, 인쇄, 커뮤니티',
   'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=800&q=80', 'levelup.owner@test.com', '010-5000-1007',
   '["GameDesign","Printing"]',
  ...
  (1013, 1032, 'BUSINESS', '페이퍼웨이브 스튜디오', '페이퍼웨이브', '310-11-000008', '도하림', DATE '2021-07-07',
   ...
   '판화, 일러스트, 컬러 매칭',
   'https://images.unsplash.com/photo-1525909002-1b05e0c869d8?auto=format&fit=crop&w=800&q=80', 'paper.owner@test.com', '010-5000-1008',
  ...
  (1014, 1033, 'BUSINESS', '문포켓 프레스', '문포켓', '310-11-000009', '유지안', DATE '2020-11-11',
   ...
   '편집, 사진, 제본',
   'https://images.unsplash.com/photo-1563968743333-044cef800494?auto=format&fit=crop&w=800&q=80', 'moonpocket.owner@test.com', '010-5000-1009',
   '["Editing","Printing"]',
